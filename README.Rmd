...
You can install the released version of shortcuts from [CRAN](https://CRAN.R-project.org) with:
...
Find Addins menu on the second bar of RStudio or create a shortcut to be faster
